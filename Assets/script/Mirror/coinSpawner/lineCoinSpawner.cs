...
using UnityEngine;
using Mirror;
public class lineCoinSpawner : NetworkBehaviour
{
    ...
    void Pick(Vector3 positionToSpawn, Quaternion rotationToSpawn)
    {
        ...
        GameObject clone1 = Instantiate(itemsToPickFrom[randomIndex], positionToSpawn + new Vector3(0, offsetFromGround, 1.5f), rotationToSpawn);
        GameObject clone2 = Instantiate(itemsToPickFrom[randomIndex], positionToSpawn + new Vector3(0, offsetFromGround, -1.5f), rotationToSpawn);
