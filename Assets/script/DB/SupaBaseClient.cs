...
// {
//     public const string SUPARBASE_URL = "https://ghrfyesekxzbkkyjvkiv.supabase.co";
//     public const string SUPARBASE_PUBLIC_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdocmZ5ZXNla3h6YmtreWp2a2l2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzcyODEyNDAsImV4cCI6MjA1Mjg1NzI0MH0.hJABFN6o-O9MjFOE3GboR6oLq_-i954wU2GdTPtcXY4";

//     private static Supabase.Client supabaseClient;

//     // Static constructor to initialize the supabase client only once
//     static SupaBaseClient()
//     {
//         supabaseClient = new Supabase.Client(SUPARBASE_URL, SUPARBASE_PUBLIC_KEY);
//     }

//     // Initialize supabase asynchronously - only to be called on server
...
//     // Checks if wallet address exists in the database
//     public static async Task<User> WalletAddressExists(string walletAddress)
//     {
//         var response = await supabaseClient
//             .From<User>()
//             .Select("wallet_address , coin_count , user_name")
//             .Where(x => x.wallet_address == walletAddress)
//             .Get();
...
//     // Adds money to the database if the wallet exists, otherwise inserts new record
//     public static async Task AddMoneyToDb(string wallet_address, int coin_count, string user_name)
//     {
//         User existingUser = await WalletAddressExists(wallet_address);
...
//                 .From<User>()
//                 .Where(x => x.wallet_address == data.wallet_address)
//                 .Set(x => x.coin_count, existingUser.coin_count + data.coin_count)
//                 .Update();
//         }
//         else
//         {
